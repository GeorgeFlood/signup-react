    ...
    <div className="page-container selectPlan-container">
      ...
      <div className="cards">
        <div
          ...
          style={{
            backgroundColor: selectedCard === 1 ? "#f8f9fe" : "white",
            border:
              selectedCard === 1
                ? "2px solid blue"
        ...
        <div
          ...
          style={{
            backgroundColor: selectedCard === 2 ? "#f8f9fe" : "white",
            border:
              selectedCard === 2
                ? "2px solid blue"
                : "2px solid rgba(0, 0, 0, 0.08)",
        ...
        <div
          ...
          style={{
            backgroundColor: selectedCard === 3 ? "#f8f9fe" : "white",
            border:
              selectedCard === 3
                ? "2px solid blue"
                : "2px solid rgba(0, 0, 0, 0.08)",
